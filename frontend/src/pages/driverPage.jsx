...
const API_KEY = ['AIzaSyC7moHWCc3Qico-PuikSbY6v3VUYbvvh_Y','AIzaSyChykMQlbWKcQy-qixkVnXCrGVoy-vdlM4']     //
...
class DriverPage extends React.Component {
    ...
    async getArrivalTime(rideInfo){
        ...
        const origin=`${startLoc.properties.latLng.lat},${startLoc.properties.latLng.lng}`
        const destination=`${endLoc.properties.latLng.lat},${endLoc.properties.latLng.lng}`
    ...
    async getRides(payload) {
        ...
        const startAddr = await getReverseGeocodingData(nonCallableStartLoc.lat,nonCallableStartLoc.lng);
        console.log(startAddr);
        const endAddr = await getReverseGeocodingData(nonCallableEndLoc.lat,nonCallableEndLoc.lng);
        let validRide = {
    ...
    render() {
        ...
        return (
            <div className="driverPageContainer">
                ...
                <MapLoader
                    googleMapURL={"https://maps.googleapis.com/maps/api/js?key=" + API_KEY[Math.floor(Math.random()*API_KEY.length)] }
