...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    const address = '0x6176dA9ed313ED1fc085B9B1a56a991eD60B5774';
  ...
  async onDriverPageSubmit(payload) {
    ...
    this.setState({
      ...
      riderStartLocation:payload.jobInfo.startLoc.properties.latLng,
      riderEndLocation: payload.jobInfo.endLoc.properties.latLng,
      tripRate: payload.jobInfo.rate,
      driverNumber,
      arrivalTime,
    });
    console.log(this.riderStartLocation)
  }
